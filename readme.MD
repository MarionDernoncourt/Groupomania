...
Depuis le dossier back-end, installer les différents packages nécessaires avec la commande ```npm instal```
...
- SERVER_PORT: port serveur back (ex: 8080),
...
Depuis le dossier front-end, installer les différents packages nécessaires avec la commande ```npm install```
### Lancement du serveur
